...
GENTOO_KERNEL_BIN_CONFIG="$(portageq envvar PORTAGE_TMPDIR)/portage/sys-kernel/gentoo-kernel-bin-${GENTOO_KERNEL_BIN_VERSION}/work/usr/src/linux-${GENTOO_KERNEL_BIN_VERSION}-gentoo-dist/.config"
...
ebuild "${GENTOO_KERNEL_BIN_EBUILD}" clean prepare
